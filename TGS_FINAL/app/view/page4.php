...
<head>
    ...
    <title>TGS - RECUPERAÇÃO DE SENHA</title>
    ...
    <main>
        ...
        <div class="ctf">
            <div class="container_formu">
                <form class="formulario" action="/TGS_FINAL/app/control/Envio_email.php" method="post">
                        <p><h1>RECUPERAÇÃO DE SENHA</h1></p>
                        </br>
                        <input type="text" placeholder="Seu Email" class="caixa" name="email">
                        </br>
                        </br>
                        </br>
